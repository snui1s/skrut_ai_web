      ...
      <main className="flex-grow pt-24 md:pt-32 pb-16 md:pb-20 px-4 md:px-8">
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <section className="space-y-3 md:space-y-4">
            <h1 className="text-3xl md:text-4xl font-bold text-secondary text-balance">Privacy Policy</h1>
          ...
          <div className="space-y-10">
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-secondary text-balance">1. No Data Persistence & No Sale</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-secondary text-balance">2. AI Processing via OpenAI (Zero Data Retention)</h2>
              <p className="text-foreground/70 leading-relaxed text-pretty">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-secondary text-balance">3. Local Session Storage</h2>
              <p className="text-foreground/70 leading-relaxed text-pretty">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-secondary text-balance">4. Ephemeral Image Processing</h2>
              <p className="text-foreground/70 leading-relaxed text-pretty">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-secondary text-balance">5. User Responsibility</h2>
              <p className="text-foreground/70 leading-relaxed text-pretty">
            ...
            <section className="space-y-4 border-l-4 border-primary pl-6 pr-2 py-2 bg-primary/5 rounded-r-xl">
              <h2 className="text-xl font-bold text-secondary italic">Our Promise</h2>
              <p className="text-foreground/70 italic text-pretty">
          ...
          <div className="pt-8 text-center">
            <p className="text-sm text-foreground/60 text-pretty">
              Questions about our privacy practices? Contact us at <a href="mailto:p.indulakshana@gmail.com" className="text-primary font-medium hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded">p.indulakshana@gmail.com</a>
            </p>
          </div>
