      ...
      <main className="flex-grow pt-24 md:pt-32 pb-16 md:pb-20 px-4 md:px-8">
        <div className="max-w-4xl mx-auto space-y-12 md:space-y-16">
          ...
          <section className="text-center space-y-4 md:space-y-6">
            <h1 className="text-3xl md:text-6xl font-bold text-secondary tracking-tight text-balance">
              Stop drowning in <span className="text-primary italic">Resumes</span>
            </h1>
            <p className="text-base md:text-xl text-foreground/70 max-w-2xl mx-auto leading-relaxed px-2 text-pretty">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-4">
            <div className="space-y-4">
              ...
              <h2 className="text-2xl font-bold text-secondary text-balance">Tackle the Volume</h2>
            ...
            <div className="space-y-4">
              <div className="w-12 h-12 bg-primary/10 rounded-2xl flex items-center justify-center text-primary mb-2 transition-transform duration-500 hover:scale-110">
                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
              </div>
              <h2 className="text-2xl font-bold text-secondary text-balance">Privacy First</h2>
              <p className="text-foreground/70 leading-relaxed text-pretty">
          ...
          <section className="space-y-12">
            <h2 className="text-3xl font-bold text-secondary text-center text-balance">The Skrut Edge</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Point 1: Transferable Skills */}
              <div className="bg-gray-50/50 p-7 rounded-3xl border border-secondary/5 space-y-4 transition-[border-color,shadow] duration-300 hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5">
          ...
          <section className="bg-white rounded-[2rem] md:rounded-[40px] border border-secondary/10 p-6 md:p-12 shadow-sm space-y-6 md:space-y-8">
            <h2 className="text-2xl md:text-3xl font-bold text-secondary text-center text-balance">The "Multi-Agent" Audit</h2>
            <p className="text-center text-foreground/70 text-sm md:text-base max-w-2xl mx-auto text-pretty">
          ...
          <section className="text-center pt-8">
             <h3 className="text-2xl font-bold text-secondary mb-6 text-balance">Ready to find your next star?</h3>
             <Link 
              href="/upload" 
